  ...
  render() {
    return (
      <>
        ...
        <Header />
        <ProjectHero
          projectName="Sketch Cluse"
          studentName="Yana Gevorgyan"
          studentWebsite="yg.is"
          studentInstagram="@yaml0rd"
        ...
        <ProjectGalleryProcess
          processImgA={processImgA}
          processImgB={processImgB}
          processImgC={processImgC}
          processImgD={processImgD}
        />
        <ProjectPreFooter />
        <Footer /> */}
      </>
